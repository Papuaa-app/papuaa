...
function UserDAO (deps) {

  const {
    dbConnector,
  } = deps;

  dbConnector.getConnector().define(UserDAO.name, {
    _id: {
    ...
    schema: dbConnector.getConnector().options.schema,
  });

  return Object.assign({}, dbConnector.abstractDAO(UserDAO), {
